...
kable(mean_mat, format = "pandoc", caption = "Table: A table showing the difference in mean of teachers' average math scaled score between class types, confidence interval fro the mean difference, and the corresponding adjusted p-values")
